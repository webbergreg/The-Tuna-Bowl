...
export const Week14 = ()=>{
    ...
    return <Recap title = {title} weekInt = {14}>
        ...
        <LazyImg className = 'inline' src = {comingSoon} alt ='Coming Soon'/> 
        ...
        <LazyImg className = 'inline' src = {throne} alt ='Throne'/> 
        <p>Oh fuck I think Moran's going to be sick!</p>
        <LazyImg className = 'inline' src = {puke} alt ='Moran once again puking'/> 
        ...
        <LazyImg className = 'inline' src = {arrows} alt ='Death by arrows!'/>
