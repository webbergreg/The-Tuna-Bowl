    ...
    return <Recap title = 'Week 10'>
        ...
        <ol>
            ...
            <li>
                ...
                <img alt = {`Timmay's notes`} src = {timNotes}/>
                ...
                <img alt = 'Dance grave 2' src = {danceGrave2}/> 
            </li>
            <li>
