...
export const Week9 = ()=>{
  const title = <>Week {WEEK_MARKERS.WEEK9}</>
  return <Recap weekInt = {9} title = {title}>
        ...
        <LazyImg alt = {`There's something about Murray`}src = {somethingMurray}/>
        ...
        <ol>
          <li>
            ...
            <LazyImg alt = 'Dance on grave' src = {danceGrave1}/>
          </li>
          <li>
            ...
            <LazyImg alt = {`Monty's back`} src = {montysBack}/>
            <p>Look out!</p>
          </li>
          <li>
