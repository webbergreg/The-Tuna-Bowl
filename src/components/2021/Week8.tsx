...
export const Week8 = ()=>{
    return <Recap title = 'Week 8 Shitcap'>
        ...
        <ol>
            <li>
                ...
                <img alt = 'Mr. Insufferable' src = {mrInsufferable}/>
            ...
            <li>
                ...
                <img alt = 'Homer Dave' src = {homerDave}/>
                ...
                <img alt = 'Dave reality check' src = {daveRealityCheck}/>
            </li>
            <li>
                ...
                <img alt = 'Upset louie' src = {upsetLouie}/>
                ...
                <img alt = 'Ryan Scared' src = {ryanScared}/>
            </li>
            <li>
